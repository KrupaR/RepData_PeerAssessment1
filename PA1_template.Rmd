...
```{r}
setwd("D:/Data specialist course/Reproducible research/Peer Review")
#
#Unzip the datafile and read it to a data set with name ActivityData
#
...
```{r}
hist(StepsPerDay$steps, main = c("Total Steps Each Day"), col="pink", xlab="Steps per Day",ylab="Frequency of count" )
```
